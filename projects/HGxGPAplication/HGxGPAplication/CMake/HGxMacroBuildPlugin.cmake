...
macro(HGxMacroBuildPlugin)
  ...
  if(NOT DEFINED Plugin-SymbolicName)
    string(REPLACE "_" "." Plugin-SymbolicName ${lib_name})
  else()
    string(REPLACE "_" "." Plugin-SymbolicName ${Plugin-SymbolicName})
  endif()
  ...
  if(NOT CMAKE_VERSION VERSION_LESS 2.8.12)
    target_include_directories(${lib_name}
      PUBLIC "$<BUILD_INTERFACE:${my_includes}>"
             "$<INSTALL_INTERFACE:include/plugins/${Plugin-SymbolicName}>"
      )
    if(CTK_QT_VERSION VERSION_LESS "5")
  ...
  if(NOT MY_TEST_PLUGIN AND NOT MY_NO_INSTALL)
    # Install rules
    install(TARGETS ${lib_name} EXPORT HGxGPAExport
      RUNTIME DESTINATION plugins COMPONENT RuntimePlugins
      LIBRARY DESTINATION plugins COMPONENT RuntimePlugins
      ARCHIVE DESTINATION plugins COMPONENT Development)
  endif()
  ...
  if(NOT MY_TEST_PLUGIN AND NOT MY_NO_INSTALL)
    ...
    install(FILES
      ${headers}
      ${dynamicHeaders}
      DESTINATION include/plugins/${Plugin-SymbolicName} COMPONENT Development
      )
  endif()
