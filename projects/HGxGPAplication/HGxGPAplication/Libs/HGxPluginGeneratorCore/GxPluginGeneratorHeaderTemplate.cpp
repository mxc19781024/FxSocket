...
const QString CGxPluginGeneratorHeaderTemplate::H_CLASSNAME_MARKER = "h_classname";
const QString CGxPluginGeneratorHeaderTemplate::H_INCLUDES_MARKER = "h_includes";
const QString CGxPluginGeneratorHeaderTemplate::H_FORWARD_DECL_MARKER = "h_forward_decl";
const QString CGxPluginGeneratorHeaderTemplate::H_FORWARD_DECL_NAMESPACE_MARKER = "h_forward_decl_namespace";
const QString CGxPluginGeneratorHeaderTemplate::H_SUPERCLASSES_MARKER = "h_superclasses";
const QString CGxPluginGeneratorHeaderTemplate::H_DEFAULT_ACCESS_MARKER = "h_default_access";
const QString CGxPluginGeneratorHeaderTemplate::H_PUBLIC_MARKER = "h_public";
const QString CGxPluginGeneratorHeaderTemplate::H_PROTECTED_MARKER = "h_protected";
const QString CGxPluginGeneratorHeaderTemplate::H_PRIVATE_MARKER = "h_private";

CGxPluginGeneratorHeaderTemplate::CGxPluginGeneratorHeaderTemplate(const QString& name, CGxPluginGeneratorAbstractTemplate* parent)
    : CGxPluginGeneratorAbstractTemplate(name, parent)
{

}

QStringList CGxPluginGeneratorHeaderTemplate::getMarkers() const
{
...
QString CGxPluginGeneratorHeaderTemplate::generateContent()
{
    QString content;
    ...
    // class declaration
    stream << "class ";
    QStringList exportMacro = this->getContent(CGxPluginGeneratorConstants::PLUGIN_EXPORTMACRO_MARKER);
