...
#ifndef GXPLUGINGENERATORCMAKELISTS_H
#define GXPLUGINGENERATORCMAKELISTS_H

#include "GxPluginGeneratorAbstractTemplate.h"

class HGX_PLUGINGENERATOR_CORE_EXPORT CGxPluginGeneratorCMakeLists
...
public:
  ...
  CGxPluginGeneratorCMakeLists(CGxPluginGeneratorAbstractTemplate *parent = 0);
...
#endif // GXPLUGINGENERATORCMAKELISTS_H
