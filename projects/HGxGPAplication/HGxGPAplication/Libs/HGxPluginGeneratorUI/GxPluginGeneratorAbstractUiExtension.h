...
#include <GxPluginGeneratorUIExport.h>

class QWidget;
class CGxPluginGeneratorAbstractUiExtensionPrivate;

class HGX_PLUGINGENERATOR_UI_EXPORT CGxPluginGeneratorAbstractUiExtension : public CGxPluginGeneratorAbstractExtension
{
