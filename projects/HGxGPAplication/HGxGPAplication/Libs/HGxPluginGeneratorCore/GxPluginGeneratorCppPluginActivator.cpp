...
const QString CGxPluginGeneratorCppPluginActivator::PLUGINACTIVATOR_START_MARKER = "pluginactivator_start";
const QString CGxPluginGeneratorCppPluginActivator::PLUGINACTIVATOR_STOP_MARKER = "pluginactivator_stop";

CGxPluginGeneratorCppPluginActivator::CGxPluginGeneratorCppPluginActivator(CGxPluginGeneratorAbstractTemplate* parent)
    : CGxPluginGeneratorCppTemplate(CGxPluginGeneratorConstants::TEMPLATE_PLUGINACTIVATOR_CPP, parent)
{

}

QString CGxPluginGeneratorCppPluginActivator::generateContent()
{
    ...
    QString exportPluginForQt4 = "Q_EXPORT_PLUGIN2(" + getSymbolicName() + ", " + getClassNameToken() + ")\n";

    QString exportPlugin = QString("#if QT_VERSION < 0x50000 \n %1#endif").arg(exportPluginForQt4);

    addContent(CPP_METHODS_MARKER, exportPlugin);

    return CGxPluginGeneratorCppTemplate::generateContent();
}

QStringList CGxPluginGeneratorCppPluginActivator::getMarkers() const
{
    QStringList markers;
