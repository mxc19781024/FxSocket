...
namespace Ui {
	class CEarthFileWindow;
}

class  CEarthFileSelectWindow : public CFxBaseWindow
{
	Q_OBJECT
	
public:
	CEarthFileSelectWindow(QWidget *parent=0);
	~CEarthFileSelectWindow();
	/**  
	  * @enum 链接类型
	*/
	enum ELinkType
...
private:
	...
	QScopedPointer<Ui::CEarthFileWindow>				ui;	
};
