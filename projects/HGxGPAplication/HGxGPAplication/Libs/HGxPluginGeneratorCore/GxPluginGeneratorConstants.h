...
#ifndef GXPLUGINGENERATORCONSTANTS_H
#define GXPLUGINGENERATORCONSTANTS_H

#include <QString>

#include <GxPluginGeneratorCoreExport.h>

struct HGX_PLUGINGENERATOR_CORE_EXPORT CGxPluginGeneratorConstants
{
...
#endif // GXPLUGINGENERATORCONSTANTS_H
