...
CMapPyramidCacheWgt::CMapPyramidCacheWgt(QWidget *parent)
	: QWidget(parent)
	, m_bPressed(false)
	,m_nHour(0)
	,m_nMintue(0)
	...
	,b_isStart(0)
{
	...
	m_image = QImage(":/images_map_layer/Resources/images_map_layer/proressBar.png");

	//读样式表文件
	QFile file(":/qss_map_layer/Resources/qss_map_layer/pyramidCache.css");
...
CMapPyramidCacheWgt::~CMapPyramidCacheWgt()
{
...
* @return
*/
void CMapPyramidCacheWgt::setCacheProcess(int nValue)
{
	m_nValue = nValue;
...
* @return
*/
void CMapPyramidCacheWgt::setRemainTime(const QString &strRemainTime)
{
	ui.remainTimeLbl->setText(strRemainTime);
}

void CMapPyramidCacheWgt::setCostTime(double dCostTime, int iCostPercent)
...
* @return
*/
void CMapPyramidCacheWgt::mousePressEvent(QMouseEvent *event)
{
...
* @return
*/
void CMapPyramidCacheWgt::mouseMoveEvent(QMouseEvent *event)
{
	if (!m_bPressed)
	{
		return;
...
* @return
*/
void CMapPyramidCacheWgt::mouseReleaseEvent(QMouseEvent *event)
{
	m_bPressed = false;
}
...
* @return
*/
void CMapPyramidCacheWgt::initSignalsAndSlots()
{
...
* @return
*/
void CMapPyramidCacheWgt::valuedChangedSlot(int nValue)
{
	QString strQss = "QProgressBar{"
		"border-image:url(:/images_map_layer/Resources/images_map_layer/progressBg.png);"
		"border-radius:2px;}"
...
void CMapPyramidCacheWgt::timerChangedSlot()
{
	if (b_isStart)
